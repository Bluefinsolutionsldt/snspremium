            ...
            <div className="flex space-x-4">
              ...
              {["facebook", "twitter", "instagram"].map((social) => (
                <a
                  key={social}
                  href={`#${social}`}
                  className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F27321]/20 flex items-center justify-center transition-colors duration-300"
                >
                  <span className="text-[#F27321]">
                    {social === "facebook" && (
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
